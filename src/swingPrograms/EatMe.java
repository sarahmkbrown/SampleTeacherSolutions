...
public class EatMe extends KeyAdapter {
   ...
   JFrame jFrame;
    ...
    private void makeAlbum() {
   	 ...
   	 images.put(new Integer(KeyEvent.VK_RIGHT), "salad.jpg");
   	 images.put(new Integer(KeyEvent.VK_DOWN), "steak.jpg");
	...
	// JOptionPane.showMessageDialog(null, "A key was pressed! Remove the code for this annoying pop-up.");
   	...
   	// 8. Print out the key that was pressed
   	 System.out.println("whichKeyPressed: " + whichKeyPressed);
   	 // 9. Print the correctUtensilCode
   	 System.out.println("correctUtensilCode: " + correctUtensilCode);
     // 10. If they match, tell the user they were correct
   	...
   	// 11. Otherwise, tell the user that they should learn some manners
   	 ...
   	 // 14. Make a variable for the number of tries and limit it to 10.
    ...
    private Component getNextRandomImage() {
   	  ...
   	  System.out.println("loading image " + randomness + ": " +
   	  randomFile);
